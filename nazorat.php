...
👨🏻‍✈️Bizning bot guruxlarda ishlaydi!
👨‍💻Gruxingizga Admin qiling va 
🤖Botimiz o'z ish faoliyatini boshlaydi
🧾Botimiz haqida to'liq ma'lumot uchun
🎗️/haqida tugmachasini bosing",
...
if((stripos($text,"/start")!==false)){
	...
	'chat_id' => $chat_id,
	'text' => "🎲 Assalomu Alaykum
👨🏻‍✈️Bizning bot guruxingizga qo'shildi!
👨‍💻Gruxingizga Admin qiling va 
🤖Botimiz o'z ish faoliyatini to'liq boshlaydi",
        ]);
}
}
...
if($get =="member"){
    ...
    bot('sendmessage', [
        'chat_id' => $chat_id,
        'text' => "🔒 <a href='tg://user?id=$uid'>$ufname</a> gruppaga reklama tarqatganingiz uchun 5 soat gruxda yoza olmaysiz! 📌Agar Guruxga 50 ta a'zo qo'shsangiz sizni ozod qilamiz!
🧾Gruxga 50 ta a'zo qo'shib pastdagi 🔐Ozod bo'lish tugmasini bosing🎁",
        'parse_mode' => 'html',
                 'reply_markup' =>  json_encode([
                'inline_keyboard' => [
...
[['text' => "🗑️Xabarni o'chirish",'callback_data'=>"och"]],
  	...
  	bot('sendmessage', [
        'chat_id' => $chat_id,
        'text' => "🎗️ <a href='tg://user?id=$uid'>$ufname</a>  Gruxingizga Kanal ulamoqchi bo'lsangiz  Kanal usernamesi ni @ siz yuboring Misol: Professional_Coders 🎁 Funksiyani o'chirish /nosoat",
        'parse_mode' => 'html',
                 'reply_markup' =>  json_encode([
                'inline_keyboard' => [
[['text' => "🗑️Xabarni o'chirish",'callback_data'=>"och"]],
...
if($step == "kan"){
	if($uid == $kanid){
		if((stripos($text,"@")!==false) or (stripos($text,".me/")!==false)){
			bot('sendmessage', [
        'chat_id' => $chat_id,
        'text' => "🎗️ <a href='tg://user?id=$uid'>$ufname</a> iltimos kanal username sini @ yoki t.me/ siz yuboring! Misol uchun @Professional_Coders endi menga shuni Professional_Coders ko'rinishida yuboring!",
        'parse_mode' => 'html',
                 'reply_markup' =>  json_encode([
                'inline_keyboard' => [
[['text' => "🗑️Xabarni o'chirish",'callback_data'=>"och"]],
