...
$API_KEY = '5053466917:AAFRwlgjCcR0b9FbG_7q-KZkPeZb2g_xP1M';
...
if (!file_exists("data/$from_id/ali.txt")) {
	...
	bot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"Assalom Alaykum! @SWH_Robot ga Hush Kelibsiz! Kerakli bo’limni tanlang:",
...
sendaction($chat_id, typing);
        bot('sendmessage', [
                'chat_id' =>$chat_id,
                'text' =>"Salom Alisher, Siz Admin Paneldasiz!",
                'parse_mode'=>'html',
      'reply_markup'=>json_encode([
            'keyboard'=>[
              [
