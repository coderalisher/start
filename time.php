...
'chat_id'=>$chat_id,
'description'=>"Gruplamizga xpsh keelipsiz",
]);
}
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=> "Assalawma aleykim $ufname $uname",
'parse_mode' => 'markdown',
...
[['text'=>'Gruppa qosiw','url'=>'telegram.me/ChannelNBPBot?startgroup=new']],
]   
]),
]);
bot('sendMessage',[
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"[$first_name](tg://user?id=$fadmin) *Sizdi? bal??iz 100 ball. ?Qutlayman Siz Gruppa Adminstratorisiz!*",
'parse_mode'=>'markdown',
]);
}if($str<"100"){
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"[$first_name](tg://user?id=$fadmin) *Adam qosqani?iz ushin Sizge 1 ball berdik! Ballari?iz sani 100 ball bol?anda Siz gruppa adminstratori?a aylanasiz* \nH¨¤zirgi ballari?iz $str",
'parse_mode'=>'markdown',
]);
}
}
