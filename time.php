...
$admin = array("2067700229","2067700229","2067700229"); 
...
📆Bùgùn kùn: òziñiz bilesiz
⏰Sağat: telefonniñ mùyishinde
📅Háfte kùni: Kalendar bar
🛡Guruppamiz: $logincha
...
😍Xosh kelipsiz, Men Guruppañizda adam sanayman \n 100 adam qossa soni admin qilaman hàm tağida gruppa infosina  sağat qoyatin bot bolaman.
💟Meni kõp gruppağa qosiñ hãm usi guruppa eng zor guruppa boladi💥

💎Esletpe! Eger siz gruppañizğa sağat qoymaqshi bolsañiz Bot Admin boliwi shart jane 100 adam qossa bot tàrepinmen admin qiliw ushin Adminler qosiwdi jağip qoyiñiz bolmasa istemidi❗️
🎁Kanallarimizğa qosilğanlarğa bepul🎁",
'parse_mode' => 'markdown',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[ 
[['text'=>'🔐 Kanalimiz 🔐', 'url' => "https://T.me/U_coder"],['text'=>'😎 Admin  😎', 'url' => "https://t.me/lifevon"]],
[['text'=>"👨‍💻 Creator 👨‍💻", 'url'=>"https://t.me/lifevon"]],
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"[$first_name](tg://user?id=$fadmin) *Adam qosqaniñiz ushin Sizge 1 ball berdik! 
Ballariñiz sani 100 ball bolğanda Siz gruppa adminstratoriğa aylanasiz*
⭕Hàzirgi ballariñiz $str",
'parse_mode'=>'markdown',
]);
}
}
